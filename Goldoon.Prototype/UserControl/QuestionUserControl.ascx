<%@ Control Language="C#" AutoEventWireup="true" CodeFile="QuestionUserControl.ascx.cs" Inherits="UserControl_QuestionUserControl" %>
    ...
    <div class="basic-body">
        <div class="row">
            <div class="col-lg-6 col-sm-12 col-xs-12 padding-top-10">
                <ItemUserControl:Question runat="server" ID="Item1" />
            </div>
            <div class="col-lg-6 col-sm-12 col-xs-12 padding-top-10">
                <ItemUserControl:Question runat="server" ID="Item2" />
            </div>
        </div>
    </div>
</div>
