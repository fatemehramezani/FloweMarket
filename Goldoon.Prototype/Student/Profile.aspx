                        ...
                        <div class="tabbable">
                            ...
                            <div class="tab-content tabs-flat">
                                            ...
                                            <div class="tabbable tabs-left">
                                                ...
                                                <div class="tab-content">
                                                    <div id="otherquestion" class="tab-pane active">
                                                        <UserControl:Question runat="server" ID="OtherQuestion" />
                                                    </div>
                                                    <div id="studentquestion" class="tab-pane">
                                                        <UserControl:Question runat="server" ID="StudentQuestion" />
                                                    </div>
                                                    <div id="studentanswer" class="tab-pane">
                                                        <UserControl:Question runat="server" ID="StudentAnswer" />
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div id="credit" class="tab-pane">
                                    <UserControl:Credit runat="server" />
                                </div>
                                <!--Payment-->
                                <div id="payment" class="tab-pane">
                                    <UserControl:Payment runat="server" />
                                </div>
                            </div>
                        </div>
                    </div>
