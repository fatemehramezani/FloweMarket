...
<asp:Content ID="Content2" ContentPlaceHolderID="TitleContentPlaceHolder" runat="Server">
    مدیریت خدمات
                                <small>
                                    <i class="fa fa-angle-right"></i>دریاچه سوالات</small>
</asp:Content>
<asp:Content ID="Content3" ContentPlaceHolderID="BodyContentPlaceHolder" runat="Server">
    <h5 class="row-title">
        <i class="typcn typcn-th-small"></i>مدیریت دریاچه سوالات</h5>
    <div class="row">
        <div class="col-md-12">
                                ...
                                <div class="widget-body">
                                    <div class="widget flat radius-bordered">
                                        <div class="widget-body">
                                            ...
                                            <h5 class="row-title">
                                                <i class="typcn typcn-folder themeprimary"></i>عملیات دریاچه سوالات در مورد مقطع راهنمایی پایه اول</h5>
                                            <div class="row">
                                                                                ...
                                                                                <ul class="header-buttons">
                                                                                    ...
                                                                                    <li class="search">
                                                                                        <span class="input-icon tooltip-primary" data-tooltip="tooltip" data-placement="bottom" data-original-title="جستجوی عنوان">
                                                                                            <input type="text" class="form-control input-sm" id="fontawsome-search" placeholder="عنوان سوال">
                                                                            ...
                                                                            <thead class="bordered-primary">
                                                                                <tr role="row">
                                                                                    ...
                                                                                    <th aria-sort="descending" aria-label="عنوان: activate to sort column ascending" colspan="1" rowspan="1" aria-controls="editabledatatable"
                                                                                        tabindex="0" class="sorting_desc">عنوان سوال</th>
                                                                                </tr>
                                                                            </thead>
                                                                            <tbody>
