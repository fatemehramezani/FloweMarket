...
function StudentList() {
    ...
    self.selectStudent = function (student) {
        ...
        studentRegisterViewModel.selectedStudentViewModel.student(student);
        //alert(studentRegisterViewModel.selectedStudentViewModel.FirstName());
        //studentRegisterViewModel.selectedStudentViewModel = student;
    }
...
function SelectedStudent()
{
    var self = this;
    // observable arrays are update binding elements upon array changes
    self.student = ko.observable(new Student(1, "متین", "کمالی", 34, "bla bla", "Male"));
    

    
}
// create index view view model which contain two models for partial views
studentRegisterViewModel = { selectedStudentViewModel: new SelectedStudent(), studentListViewModel: new StudentList() };
