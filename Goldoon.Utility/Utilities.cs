...
namespace Goldoon.Utility
{
    public static class Utilities
    {
        ...
        public static string ContentFor(this UrlHelper helper, string key)
        {
            return helper.Action("Preview", "Content", new { id = key });
        }
        public static string ThumbFor(this UrlHelper helper, long? id, int size = 250)
        {
            return helper.Action("Thumb", "File", new { id, size });
        }
